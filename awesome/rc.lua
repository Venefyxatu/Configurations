...
-- Tyrannical for fancy tags
local tyrannical = require("tyrannical")

-- Blind... pretty themes!
-- Forgotten, because you don't want to forget your config?
...
-- }}}
-- Tyrannical tag configuration
tyrannical.settings.default_layout =  awful.layout.suit.tile.top
tyrannical.settings.mwfact = 0.75
tyrannical.settings.block_children_focus_stealing = true -- Stop dialogs from stealing focus
tyrannical.settings.group_children = true  -- Force children into the same tag as their parent
...
do -- Change focus_relative to put the mouse out of the way
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "Return", function () awful.spawn(pure_terminal) end,
              {description = "open a tmux-free terminal", group = "launcher"}),
